            ...
            <header className='flex flex-col gap-5 md:gap-8'>
                ...
                <Link href='/' className="cursor-pointer flex items-center gap-1 ">
                    <Image
                        ...
                        alt='Horizon Logo'
                    />
                    <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">BankSphere</h1>
                </Link>
                        ...
                        {type === 'sign-up' && (
                            <>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <CustomInput control={form.control} name='postalCode' label='Postal Code' placeholder='Example:11223' />
                                </div>
                                <div className="flex gap-4">
